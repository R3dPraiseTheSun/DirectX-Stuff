    ...
    D3D12_RESOURCE_FLAGS flags)
{
    ...
    CD3DX12_RESOURCE_DESC resourceDesc0 = (CD3DX12_RESOURCE_DESC::Buffer(bufferSize, flags));
    ...
    if (bufferData)
    {
        ...
        CD3DX12_RESOURCE_DESC resourceDesc1 = (CD3DX12_RESOURCE_DESC::Buffer(bufferSize));
        ThrowIfFailed(device->CreateCommittedResource(
            &heapProps1,
            D3D12_HEAP_FLAG_NONE,
            &resourceDesc1,
...
void Tutorial2::ResizeDepthBuffer(int width, int height)
{
    if (m_ContentLoaded)
    {
        ...
        CD3DX12_RESOURCE_DESC resourceDesc2(CD3DX12_RESOURCE_DESC::Tex2D(DXGI_FORMAT_D32_FLOAT, width, height,
